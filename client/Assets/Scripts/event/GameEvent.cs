...
{
    public static GameEvent operator +(GameEvent p1, Action p2)
    {
        p1.AddListener(p2);
        return p1;
    }
...
public class GameEvent<T> : EventBase
{
    public static GameEvent<T> operator +(GameEvent<T> p1, Action<T> p2)
    {
        p1.AddListener(p2);
        return p1;
    }
...
public class GameEvent<T1, T2> : EventBase
{
    public static GameEvent<T1, T2> operator +(GameEvent<T1, T2> p1, Action<T1, T2> p2)
    {
        p1.AddListener(p2);
        return p1;
    }
...
public class GameEvent<T1, T2, T3> : EventBase
{
    public static GameEvent<T1, T2, T3> operator +(GameEvent<T1, T2, T3> p1, Action<T1, T2, T3> p2)
    {
        p1.AddListener(p2);
        return p1;
    }
...
public class GameEvent<T1, T2, T3, T4> : EventBase
{
    public static GameEvent<T1, T2, T3, T4> operator +(GameEvent<T1, T2, T3, T4> p1, Action<T1, T2, T3, T4> p2)
    {
        p1.AddListener(p2);
        return p1;
    }
